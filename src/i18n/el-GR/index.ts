export default {
  ...
  selectOptions: {
    ...
    urgentDelivery: {
      normal: 'Κανονική Παράδοση',
      urgent: 'Επείγουσα Παράδοση'
    },
    deliveryPickup: {
      simple: 'Απλή παράδοση',
      pickup: 'Παράδοση - Παραλαβή'
    },
    sameDay: {
      normal: 'Κανονική παράδοση',
      sameDay: 'Αυθημερόν'
    ...
    protocolNumber: {
      none: 'Χωρίς Πρωτόκολλο',
      simple: 'Με Πρωτόκολλο'
    }
  },
  click_me: "Κάντε κλικ σε μένα",
  hello_there: "Γεια σου!",
  header: "Κεφαλίδα",
  footer: "Υποσέλιδο",
  error_404: "404",
  oops_nothing_here: "Ωχ, δεν υπάρχει τίποτα εδώ!",
  go_home: "Πήγαινε στην αρχική",
  login: "Σύνδεση",
  sign_up: "Εγγραφή",
  docs: "Έγγραφα",
  docs_caption: "quasar.dev",
  github: "GitHub",
  github_caption: "github.com/quasarframework",
  discord_chat_channel: "Κανάλι συνομιλίας Discord",
  discord_chat_caption: "chat.quasar.dev",
  forum: "Φόρουμ",
  forum_caption: "forum.quasar.dev",
  twitter: "Twitter",
  twitter_caption: "@quasarframework",
  facebook: "Facebook",
  facebook_caption: "@QuasarFramework",
  quasar_awesome: "Quasar Awesome",
  quasar_awesome_caption: "Κοινοτικά έργα Quasar",
  users_app: "Εφαρμογή χρηστών",
  essential_links: "Βασικοί σύνδεσμοι",
  open_menu: "Άνοιγμα μενού",
  item: "Αντικείμενο",
  drawer_label: "Ετικέτα ντουλαπιού",
  am_i_on_screen: "Είμαι στην οθόνη;",
  ok: "ΟΚ",
  cancel: "Ακύρωση",
